        ...
        if ($getCourseData != false) {
            ...
            while ($rowData = $getCourseData->fetch_assoc()) {
                ...
                <td><form action='editCourse.php' method='post'><input type='hidden' name='branchId' value='" . $_branchId . "'>
                    ...
                    <button type='submit' class='btn btn-primary' value='Edit'><i class='fa fa-pencil'></i>&nbspEdit</button></form></td><td>
                    <form action='delete_course.php' method='post'><input type='hidden' name='courseId' value='" . $_courseId . "'><button type='submit' class='btn btn-danger' value='Delete'><i class='fa fa-trash'></i>&nbspDelete</button></form></td></tr>";
                    $id++;
                }
                echo "</table><br>";
            } else {
