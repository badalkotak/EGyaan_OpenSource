...
if (isset($_REQUEST['firstName']) && isset($_REQUEST['lastName']) && isset($_REQUEST['emailId']) && isset($_REQUEST['studentPassword'])
    ...
    && !empty(trim($_REQUEST['lastName'])) && !empty(trim($_REQUEST['emailId'])) && !empty(trim($_REQUEST['studentPassword']))
    && !empty(trim($_REQUEST['mobile'])) && !empty(trim($_REQUEST['gender'])) && !empty(trim($_REQUEST['parentName']))
    && !empty(trim($_REQUEST['parentEmail'])) && !empty(trim($_REQUEST['parentPassword'])) && !empty(trim($_REQUEST['totalFees']))
