...
$result_get_student_batch=$student->getStudent($user_id,0);
if($result_get_student_batch!=null)
{
	while($row_student_batch=$result_get_student_batch->fetch_assoc())
	{
		$batch_id=$row_student_batch['batch_id'];
	}
}
?>
<!-- =============================================== -->
