            ...
            <div class="row">
				...
				<tbody>";
                                while ($row = $getRoles->fetch_assoc()) {
                                    ...
                                    echo "<td>";
                                    echo "<form role='form' action=view_privilege.php method=post><button class='btn btn-primary' type=submit name=view id=view value='$id'><i class='fa fa-eye'></i>&nbsp;View</button></form>";
                                    echo "</td>";
